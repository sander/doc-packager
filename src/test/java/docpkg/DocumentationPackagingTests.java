...
public class DocumentationPackagingTests {
  ...
  void addsFiles() {
    ...
    var pathString = "docpkg/example/document.md";
    var url = getClass().getClassLoader().getResource(pathString);
    assert url != null;
    ...
    var description = new DocumentationPackaging.FileDescription(relativePath);
    service.publish(List.of(description));
  }
}
